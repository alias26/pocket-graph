"""Validate extraction JSON against the documented schema."""
...
def validate_extraction(data: dict) -> list[str]:
    """Validate an extraction JSON dict. Returns list of error strings (empty == valid)."""
    ...
    # Edges (accept "links" alias for NetworkX <= 3.1)
...
__all__ = ["VALID_FILE_TYPES", "VALID_CONFIDENCES",
           "REQUIRED_NODE_FIELDS", "REQUIRED_EDGE_FIELDS",
